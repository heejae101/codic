...
<c:if test="${empty sessionScope.nickname}">
	...
	<section id="update-section">
		...
		<form method="POST" action="/UpdateUser">
			<div class="form_div">
				<div>
					<label for="email">이메일</label> <input type="text" id=user_email
						name="user_email" value="${sessionScope.log1}" readonly>
				</div>
				<div class="pwd1">
				...
				<div class="pwd2">
					<label for="pwd2">새 비밀번호</label> <input type="password"
				...
				<div class="pwd3">
					<label for="pwd3">새 비밀번호 확인</label> <input type="password"
				...
				<div>
					<label for="name">이름</label> <input type="text" id="user_name"
						name="user_name" value="${sessionScope.log2}" readonly>
				</div>

				<div>
					<label for="nicekname">닉네임</label> <input type="text"
						id="user_nickname" name="user_nickname"
						value="${requestScope.nickname}"> <input type="button"
						id="user_nickname_dupl" name="user_nickname_dupl" value="중복 체크"
						onclick="duplCheck()"></input>
					<ul>
			...
			<input type="button" id="submit" value="회원정보 수정"
