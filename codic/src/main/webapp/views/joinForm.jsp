			...
			<form method="POST" action="Join">
					...
					<div class="pwd1">
						...
						<input type="password"
							...
							placeholder="4-10자의 영문, 특수문자, 숫자 조합"> <p
							class="err"> *특수문자는 '! @ # $ % ^ & +='만 사용 가능합니다.</p>
					...
					<div class="pwd2">
						...
						<input type="password"
							...
							placeholder="비밀번호 확인"> <span class="err" id="chkNotice2" size="1"></span>
					</div>
					</div>
				...
				<div>
					<label for="nickname" class="title">닉네임<span class="required">(필수)</span></label> 
				...
				<div class="label-wrapper">
					<label for="agree_all" class="title">이용약관 동의<span class="required">(필수)</span></label> 
					<div class="agr">
					<input type="checkbox" id="agree_all" name="agree_all"><span class="agr_text">전체동의</span>
					</div>
					

					<div class="agr">
						<label for="agree"><input type="checkbox" id="user_check1"
							name="user_check" value="1"><span class="agr_text">이용약관 동의<strong>(필수)</strong></span></label>
					</div>

					<div class="agr">
						<label for="agree"><input type="checkbox" id="user_check2"
							name="user_check" value="1"><span class="agr_text">개인정보 수집,이용 동의<strong>(필수)</strong></span>
						</label>
					</div>
